...
class TokenModel extends TokenEntity {
  const TokenModel({required String? token, required AllUserDataModel? user})
...
class UserDataModel extends UserDataEntity {
  ...
  factory UserDataModel.fromJson(Map<String, dynamic> json) {
    ...
    final tokenModel = token != null ? TokenModel.fromJson(token) : null;

    return UserDataModel(
        massage: massage, statue: statue, tokenModel: tokenModel);
  }
}
